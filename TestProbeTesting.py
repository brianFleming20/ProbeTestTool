...
class ProbeTests(unittest.TestCase):
    ...
    def test_non_human_probe(self):
        print("Test non human probe flag set")
        not_set = DS.get_user_data()['Non_Human']
        self.assertFalse(not_set)

        non_human = self.PT.non_human_probe()
        self.assertEqual(non_human, not_set)

        probe_set = P.Users("Brian", True, non_human=True)
        DS.write_user_data(probe_set)

        animal_set = DS.get_user_data()['Non_Human']
        self.assertTrue(animal_set)

        non_human_set = self.PT.non_human_probe()
        self.assertEqual(animal_set, non_human_set)
